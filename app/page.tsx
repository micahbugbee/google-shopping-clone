...
export default function Home() {
  return (
    <div className="p-10 pt-0 text-center md:text-left">
      ...
      <h2 className='mb-5'>Get started by clicking on one of the example search items or typing in an item yourself above!
      </h2>

      <div className="grid gird-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 justify-center items-center gap-5 mt-5">

      {
        // map through searches and display the items
        searches.map((search) => (
          <Link
            prefetch={false}
            key={search.id}
